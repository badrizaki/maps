        ...
        LocationListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        /* AUTOCOMPLETE KETIKA EDITTEXT FROM DI TULIS */
        ...
        txtFrom.addTextChangedListener(new TextWatcher()
        {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count)
            {
                ...
                placesTask.execute(s.toString(), "from");
            }
            @Override
        ...
        // AUTOCOMPLETE KETIKA EDITTEXT TO DI TULIS 
        txtTo.setThreshold(1);
        txtTo.addTextChangedListener(new TextWatcher()
        {
            ...
            {
                placesTask = new PlacesTask();              
                placesTask.execute(s.toString(), "to");
            }
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                // TODO Auto-generated method stub
    ...
    public void onMapReady(GoogleMap googleMap)
    {
        ...
        /* CALL FUNCTION GET DATA LOCATION DRIVER */
        getDataLocationDriver();
    ...
    public void getDataLocationDriver()
    {
        /*******************
         * GET DATA FROM API
        */
    ...
    */
    private class PlacesTask extends AsyncTask<String, Void, String>
    {
        ...
        protected String doInBackground(String... place)
        {
            ...
            String key = "key=AIzaSyDW_K7Xos8FzEKdV3dVsHMHJOh0Ibpyz3A";
            String input = "";
            try {
                input = place[0].replace(" ", "+");
                input = input.replace(" ", "+");
        ...
        {
            super.onPostExecute(result, type);
            // Creating ParserTask
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<HashMap<String,String>>>
    {
        ...
        @Override
        protected void onPostExecute(List<HashMap<String, String>> result, String type)
        {
    ...
    public void searchAddress(View view)
    {
        ...
        EditText etLocation = (EditText) findViewById(R.id.txtFrom);
    ...
    /**
     * A class to parse the Google Places in JSON format
     * Dengan click di map bukan search
     */
/*
